...
//integer types used for storage
  ...
  enum TriggerBits {
    ...
    kHLT_DiCentralPFJet55_PFMET110_NoiseCleaned_v1 = 1UL<<5,
    kHLT_DiCentralPFJet70_PFMET120_NoiseCleaned_v1 = 1UL<<6,
    kHLT_PFHT350_PFMET100_NoiseCleaned_v1 = 1UL<<7,
    kHLT_PFHT350_PFMET120_NoiseCleaned_v1 = 1UL<<8,
    kHLT_PFMET170_NoiseCleaned_v1 = 1UL<<9,
    kHLT_PFMET170_NoiseCleaned_v2 = 1UL<<9,
    kHLT_PFMET120_NoiseCleaned_BTagCSV07_v1 = 1UL<<10,
    kHLT_PFMET120_NoiseCleaned_BTagCSV072_v1 = 1UL<<11,
    kHLT_PFMET120_NoiseCleaned_BTagCSV072_v2 = 1UL<<12,
    kHLT_PFHT300_v1 = 1UL<<13,
    kHLT_PFHT350_v1 = 1UL<<14,
    kHLT_PFHT350_v2 = 1UL<<15,
    kHLT_PFHT400_v1 = 1UL<<16,
    kHLT_PFHT475_v1 = 1UL<<17,
    kHLT_PFHT600_v1 = 1UL<<18,
    kHLT_PFHT600_v2 = 1UL<<19,
    kHLT_PFHT650_v1 = 1UL<<20,
    kHLT_PFHT800_v1 = 1UL<<21,
    kHLT_PFHT900_v1 = 1UL<<22,
    kHLT_IsoMu24_eta2p1_v2 = 1UL<<23,
    kHLT_IsoMu27_v2 = 1UL<<24,
    kHLT_IsoTkMu24_eta2p1_v2 = 1UL<<25,
    kHLT_IsoTkMu27_v2 = 1UL<<26,
    kHLT_Photon120_R9Id90_HE10_IsoM_v2 = 1UL<<27,
    kHLT_Photon165_R9Id90_HE10_IsoM_v2 = 1UL<<28,
    kHLT_Photon165_HE10_v2 = 1UL<<29,
    kHLT_Photon175_v2 = 1UL<<30
  };
