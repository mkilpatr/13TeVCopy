...
from AnalysisTools.ObjectSelection.cutBasedPhotonID_tools import *
...
isoInputs = IsolationCutInputs(
    ...
    "data/Spring15/effAreaPhotons_cone03_pfChargedHadrons_25ns_NULLcorrection.txt",
    # neuHadIsolationMapName
    'photonIDValueMapProducer:phoNeutralHadronIsolation' ,
    # neuHadIsolationEffAreas
    "data/Spring15/effAreaPhotons_cone03_pfNeutralHadrons_25ns_90percentBased.txt" ,
    # phoIsolationMapName  
    "photonIDValueMapProducer:phoPhotonIsolation" ,
    # phoIsolationEffAreas
    "data/Spring15/effAreaPhotons_cone03_pfPhotons_25ns_90percentBased.txt"
)
