...
namespace ucsbsusy {
  ...
  class TauMVA {
    ...
    private :
      ...
      const int index_chiso0p1;
      const int index_chiso0p2;
      const int index_chiso0p3;
      const int index_chiso0p4;
      const int index_totiso0p1;
      const int index_totiso0p2;
      const int index_totiso0p3;
      const int index_totiso0p4;
