#include "AnalysisTools/ObjectSelection/interface/ElectronMVAEstimatorRun2Spring15NonTrigv2.h"
...
ElectronMVAEstimatorRun2Spring15NonTrigv2::ElectronMVAEstimatorRun2Spring15NonTrigv2(const edm::ParameterSet& conf):
...
ElectronMVAEstimatorRun2Spring15NonTrigv2::
~ElectronMVAEstimatorRun2Spring15NonTrigv2(){
}


void ElectronMVAEstimatorRun2Spring15NonTrigv2::setConsumes(edm::ConsumesCollector&& cc) const {
...
float ElectronMVAEstimatorRun2Spring15NonTrigv2::
...
int ElectronMVAEstimatorRun2Spring15NonTrigv2::findCategory( const edm::Ptr<reco::Candidate>& particle) const {
...
bool ElectronMVAEstimatorRun2Spring15NonTrigv2::
...
std::unique_ptr<const GBRForest> ElectronMVAEstimatorRun2Spring15NonTrigv2::
...
std::vector<float> ElectronMVAEstimatorRun2Spring15NonTrigv2::
...
void ElectronMVAEstimatorRun2Spring15NonTrigv2::constrainMVAVariables(AllVariables& allMVAVars) const {
