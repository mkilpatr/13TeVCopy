...
parser.add_argument("-m", "--runmacro", dest="macro", default="process1lepSearch.C", help="ROOT macro to run. [Default: processSingleLepton.C]")
...
parser.add_argument("-o", "--outdir", dest="outdir", default="${PWD}/trees", help="Output directory for plots, [Default: \"${PWD}/plots\"]")
