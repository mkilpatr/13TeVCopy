...
hadd nonqcd_qcdcr_tree.root ttbarplusw_tree.root znunu_tree.root
cd ..
ln -s sr/met_tree.root data_tree.root
ln -s sr/znunu_tree.root
ln -s sr/ttbarplusw_tree.root
ln -s sr/qcd_tree.root
ln -s sr/signals/*.root ./
...
ln -s ../sr/ttbarplusw_tree.root
ln -s ../lepcr/signals/*.root ./

# qcdcr
cd ..
ln -s sr/met_tree.root data_qcdcr_tree.root
ln -s sr/qcd_tree.root qcd_qcdcr_tree.root
ln -s sr/nonqcd_qcdcr_tree.root

# photoncr
cd photoncr
hadd photon_tree.root gjets_tree.root qcd-fake_tree.root qcd-frag_tree.root
...
rm dyjetstoll-madgraph_tree.root tZq_tree.root ttZ_tree.root ttbar-mg_tree.root ttW_tree.root tW_tree.root
cd ..
