...
public:
  ...
  void  loadVars() {
    ...
    if(reco){
      ...
      addVariable("ptD"      ,"ak4_genjet_ptD"    ,'F');
    ...
    //addVariableSet("ptD", "axis1", "axis2", "");
  }
  ...
  void configure(){
    ...
    if (reco) {
		...
		else          addAxis( new BinnedSpace("ak4_jet_pt",         "ak4_jet_pt",         "20,100,6000") );
    	...
    	// loosely binned test
		addAxis( new BinnedSpace("ak4_genjet_pt",       "ak4_genjet_pt",       "20,100,300,6000") );
