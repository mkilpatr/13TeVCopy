...
public:
  ...
  void configure(){
    ...
    if (reco) {
		...
		addAxis(               new BinnedSpace("ak4pfchs_jet_eta",   "ak4pfchs_jet_eta",   "0,2.4")     );
    } // reco
    else {
		...
		addAxis( new BinnedSpace("ak4pfchs_genjet_eta", "ak4pfchs_genjet_eta", "0,2.4")     );
    } // !reco
