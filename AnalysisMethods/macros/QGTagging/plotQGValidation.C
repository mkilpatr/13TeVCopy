                     ...
                     )
{
  ...
  zjetPlots->addTreeVar("zjets_j0eta_pt20", "j0eta", "passZjet && passZmass"+pt020     , "#eta (pt30)" , 30, -5,   5 );
...
//zjetPlots->addTreeVar("zjets_forward200_j0qgl", "j0qgl", "passZjet && passZmass"+forward+pt200, "QGL", 30, 0, 1 );
  ...
  dijetPlots->addTreeVar("dijets_j0pt" , "j0pt" , "passDijet && passDijet3", "pt_{T} [GeV]", 40, 200, 1000 );
  dijetPlots->addTreeVar("dijets_j0eta", "j0eta", "passDijet && passDijet3", "#eta"        , 30,  -5,    5 );
  dijetPlots->addTreeVar("dijets_rho"  , "rho"  , "passDijet && passDijet3", "#rho"        , 25,   0,   25 );
  dijetPlots->addTreeVar("dijets_npv"  , "npv"  , "passDijet && passDijet3", "npv"         , 34,   1,   34 );
  dijetPlots->addTreeVar("dijets_central_j0mult"   , "j0mult", "passDijet && passDijet3"+central+ptlow, "multiplicity", 35, 0, 70 );
//dijetPlots->addTreeVar("dijets_central020_j0mult", "j0mult", "passDijet && passDijet3"+central+pt020, "multiplicity", 35, 0, 70 );
  dijetPlots->addTreeVar("dijets_central030_j0mult", "j0mult", "passDijet && passDijet3"+central+pt030, "multiplicity", 35, 0, 70 );
  dijetPlots->addTreeVar("dijets_central040_j0mult", "j0mult", "passDijet && passDijet3"+central+pt040, "multiplicity", 35, 0, 70 );
  dijetPlots->addTreeVar("dijets_central060_j0mult", "j0mult", "passDijet && passDijet3"+central+pt060, "multiplicity", 35, 0, 70 );
  dijetPlots->addTreeVar("dijets_central080_j0mult", "j0mult", "passDijet && passDijet3"+central+pt080, "multiplicity", 35, 0, 70 );
  dijetPlots->addTreeVar("dijets_central120_j0mult", "j0mult", "passDijet && passDijet3"+central+pt120, "multiplicity", 35, 0, 70 );
  dijetPlots->addTreeVar("dijets_central200_j0mult", "j0mult", "passDijet && passDijet3"+central+pt200, "multiplicity", 35, 0, 70 );
  dijetPlots->addTreeVar("dijets_forward_j0mult"   , "j0mult", "passDijet && passDijet3"+forward+ptlow, "multiplicity", 35, 0, 70 );
//dijetPlots->addTreeVar("dijets_forward020_j0mult", "j0mult", "passDijet && passDijet3"+forward+pt020, "multiplicity", 35, 0, 70 );
//dijetPlots->addTreeVar("dijets_forward030_j0mult", "j0mult", "passDijet && passDijet3"+forward+pt030, "multiplicity", 35, 0, 70 );
//dijetPlots->addTreeVar("dijets_forward040_j0mult", "j0mult", "passDijet && passDijet3"+forward+pt040, "multiplicity", 35, 0, 70 );
//dijetPlots->addTreeVar("dijets_forward060_j0mult", "j0mult", "passDijet && passDijet3"+forward+pt060, "multiplicity", 35, 0, 70 );
//dijetPlots->addTreeVar("dijets_forward080_j0mult", "j0mult", "passDijet && passDijet3"+forward+pt080, "multiplicity", 35, 0, 70 );
//dijetPlots->addTreeVar("dijets_forward120_j0mult", "j0mult", "passDijet && passDijet3"+forward+pt120, "multiplicity", 35, 0, 70 );
//dijetPlots->addTreeVar("dijets_forward200_j0mult", "j0mult", "passDijet && passDijet3"+forward+pt200, "multiplicity", 35, 0, 70 );
  dijetPlots->addTreeVar("dijets_central_j0ptd"   , "j0ptd", "passDijet && passDijet3"+central+ptlow, "ptD", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_central020_j0ptd", "j0ptd", "passDijet && passDijet3"+central+pt020, "ptD", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central030_j0ptd", "j0ptd", "passDijet && passDijet3"+central+pt030, "ptD", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central040_j0ptd", "j0ptd", "passDijet && passDijet3"+central+pt040, "ptD", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central060_j0ptd", "j0ptd", "passDijet && passDijet3"+central+pt060, "ptD", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central080_j0ptd", "j0ptd", "passDijet && passDijet3"+central+pt080, "ptD", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central120_j0ptd", "j0ptd", "passDijet && passDijet3"+central+pt120, "ptD", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central200_j0ptd", "j0ptd", "passDijet && passDijet3"+central+pt200, "ptD", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_forward_j0ptd"   , "j0ptd", "passDijet && passDijet3"+forward+ptlow, "ptD", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward020_j0ptd", "j0ptd", "passDijet && passDijet3"+forward+pt020, "ptD", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward030_j0ptd", "j0ptd", "passDijet && passDijet3"+forward+pt030, "ptD", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward040_j0ptd", "j0ptd", "passDijet && passDijet3"+forward+pt040, "ptD", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward060_j0ptd", "j0ptd", "passDijet && passDijet3"+forward+pt060, "ptD", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward080_j0ptd", "j0ptd", "passDijet && passDijet3"+forward+pt080, "ptD", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward120_j0ptd", "j0ptd", "passDijet && passDijet3"+forward+pt120, "ptD", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward200_j0ptd", "j0ptd", "passDijet && passDijet3"+forward+pt200, "ptD", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central_j0axis1"   , "j0axis1", "passDijet && passDijet3"+central+ptlow, "-Log(axis_{1})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_central020_j0axis1", "j0axis1", "passDijet && passDijet3"+central+pt020, "-Log(axis_{1})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central030_j0axis1", "j0axis1", "passDijet && passDijet3"+central+pt030, "-Log(axis_{1})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central040_j0axis1", "j0axis1", "passDijet && passDijet3"+central+pt040, "-Log(axis_{1})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central060_j0axis1", "j0axis1", "passDijet && passDijet3"+central+pt060, "-Log(axis_{1})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central080_j0axis1", "j0axis1", "passDijet && passDijet3"+central+pt080, "-Log(axis_{1})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central120_j0axis1", "j0axis1", "passDijet && passDijet3"+central+pt120, "-Log(axis_{1})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central200_j0axis1", "j0axis1", "passDijet && passDijet3"+central+pt200, "-Log(axis_{1})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_forward_j0axis1"   , "j0axis1", "passDijet && passDijet3"+forward+ptlow, "-Log(axis_{1})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward020_j0axis1", "j0axis1", "passDijet && passDijet3"+forward+pt020, "-Log(axis_{1})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward030_j0axis1", "j0axis1", "passDijet && passDijet3"+forward+pt030, "-Log(axis_{1})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward040_j0axis1", "j0axis1", "passDijet && passDijet3"+forward+pt040, "-Log(axis_{1})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward060_j0axis1", "j0axis1", "passDijet && passDijet3"+forward+pt060, "-Log(axis_{1})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward080_j0axis1", "j0axis1", "passDijet && passDijet3"+forward+pt080, "-Log(axis_{1})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward120_j0axis1", "j0axis1", "passDijet && passDijet3"+forward+pt120, "-Log(axis_{1})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward200_j0axis1", "j0axis1", "passDijet && passDijet3"+forward+pt200, "-Log(axis_{1})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central_j0axis2"   , "j0axis2", "passDijet && passDijet3"+central+ptlow, "-Log(axis_{2})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_central020_j0axis2", "j0axis2", "passDijet && passDijet3"+central+pt020, "-Log(axis_{2})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central030_j0axis2", "j0axis2", "passDijet && passDijet3"+central+pt030, "-Log(axis_{2})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central040_j0axis2", "j0axis2", "passDijet && passDijet3"+central+pt040, "-Log(axis_{2})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central060_j0axis2", "j0axis2", "passDijet && passDijet3"+central+pt060, "-Log(axis_{2})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central080_j0axis2", "j0axis2", "passDijet && passDijet3"+central+pt080, "-Log(axis_{2})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central120_j0axis2", "j0axis2", "passDijet && passDijet3"+central+pt120, "-Log(axis_{2})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central200_j0axis2", "j0axis2", "passDijet && passDijet3"+central+pt200, "-Log(axis_{2})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_forward_j0axis2"   , "j0axis2", "passDijet && passDijet3"+forward+ptlow, "-Log(axis_{2})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward020_j0axis2", "j0axis2", "passDijet && passDijet3"+forward+pt020, "-Log(axis_{2})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward030_j0axis2", "j0axis2", "passDijet && passDijet3"+forward+pt030, "-Log(axis_{2})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward040_j0axis2", "j0axis2", "passDijet && passDijet3"+forward+pt040, "-Log(axis_{2})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward060_j0axis2", "j0axis2", "passDijet && passDijet3"+forward+pt060, "-Log(axis_{2})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward080_j0axis2", "j0axis2", "passDijet && passDijet3"+forward+pt080, "-Log(axis_{2})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward120_j0axis2", "j0axis2", "passDijet && passDijet3"+forward+pt120, "-Log(axis_{2})", 30, 0, 10 );
//dijetPlots->addTreeVar("dijets_forward200_j0axis2", "j0axis2", "passDijet && passDijet3"+forward+pt200, "-Log(axis_{2})", 30, 0, 10 );
  dijetPlots->addTreeVar("dijets_central_j0qgl"   , "j0qgl", "passDijet && passDijet3"+central+ptlow, "QGL", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_central020_j0qgl", "j0qgl", "passDijet && passDijet3"+central+pt020, "QGL", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central030_j0qgl", "j0qgl", "passDijet && passDijet3"+central+pt030, "QGL", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central040_j0qgl", "j0qgl", "passDijet && passDijet3"+central+pt040, "QGL", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central060_j0qgl", "j0qgl", "passDijet && passDijet3"+central+pt060, "QGL", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central080_j0qgl", "j0qgl", "passDijet && passDijet3"+central+pt080, "QGL", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central120_j0qgl", "j0qgl", "passDijet && passDijet3"+central+pt120, "QGL", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_central200_j0qgl", "j0qgl", "passDijet && passDijet3"+central+pt200, "QGL", 30, 0, 1 );
  dijetPlots->addTreeVar("dijets_forward_j0qgl"   , "j0qgl", "passDijet && passDijet3"+forward+ptlow, "QGL", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward020_j0qgl", "j0qgl", "passDijet && passDijet3"+forward+pt020, "QGL", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward030_j0qgl", "j0qgl", "passDijet && passDijet3"+forward+pt030, "QGL", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward040_j0qgl", "j0qgl", "passDijet && passDijet3"+forward+pt040, "QGL", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward060_j0qgl", "j0qgl", "passDijet && passDijet3"+forward+pt060, "QGL", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward080_j0qgl", "j0qgl", "passDijet && passDijet3"+forward+pt080, "QGL", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward120_j0qgl", "j0qgl", "passDijet && passDijet3"+forward+pt120, "QGL", 30, 0, 1 );
//dijetPlots->addTreeVar("dijets_forward200_j0qgl", "j0qgl", "passDijet && passDijet3"+forward+pt200, "QGL", 30, 0, 1 );
