...
////Rename to your scale factors
   ...
   bool Ratio(TString outFile,TString cut1,TString cut2,TString  file1,TString  file2,TString title,TString selection1, TString selection2,
...
//	  h2->DrawCopy("E histsame");
   ...
   //// Clone h2 into h3
	  ...
	  h3->SetTitle(selection1+"/"+selection2+";;");
