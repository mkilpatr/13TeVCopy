...
void getQCDPrediction(const TString defaultdir  = "/eos/uscms/store/user/vdutta/13TeV/trees/121815",
                      ...
                      vector<TString> vars      = {""}, //,"btag","mistag","jes","pu"},
                      const bool    plotlog     = false)
{
  ...
  sel["nt0_lowmt"]    = " && ncttstd==0 && mtcsv12met<=175";
  sel["nt0_highmt"]   = " && ncttstd==0 && mtcsv12met>175";
  sel["nt1_lowmt"]    = " && ncttstd>0 && mtcsv12met<=175";
  sel["nt1_highmt"]   = " && ncttstd>0 && mtcsv12met>175";
  sel["nb1_nt0_lowmt"]    = " && nbjets==1 && ncttstd==0 && mtcsv12met<=175";
  sel["nb2_nt0_lowmt"]    = " && nbjets>=2 && ncttstd==0 && mtcsv12met<=175";
  sel["nb1_nt1_lowmt"]    = " && nbjets==1 && ncttstd>0 && mtcsv12met<=175";
  sel["nb2_nt1_lowmt"]    = " && nbjets>=2 && ncttstd>0 && mtcsv12met<=175";
  ...
  for(unsigned int i = 0; i < vars.size(); ++i) {
    ...
    for(unsigned int ivar = 0; ivar != NONE; ++ivar) {
      ...
      plots0l->addTreeVar("met_sr_nb1_nt0_lowmt",                 "met",         sel["sr"] + sel["nb1_nt0_lowmt"],      "#slash{E}_{T} [GeV]", NBINS, metbins);
      plots0l->addTreeVar("met_sr_nb2_nt0_lowmt",                 "met",         sel["sr"] + sel["nb2_nt0_lowmt"],      "#slash{E}_{T} [GeV]", NBINS, metbins);
      plots0l->addTreeVar("met_sr_nb1_nt1_lowmt",                 "met",         sel["sr"] + sel["nb1_nt1_lowmt"],      "#slash{E}_{T} [GeV]", NBINS, metbins);
      plots0l->addTreeVar("met_sr_nb2_nt1_lowmt",                 "met",         sel["sr"] + sel["nb2_nt1_lowmt"],      "#slash{E}_{T} [GeV]", NBINS, metbins);
      ...
      plots0l->addTreeVar("met_qcdcr_nbgeq1_nt0_lowmt",    "met",         sel["qcdcr"] + sel["nt0_lowmt"],                "#slash{E}_{T} [GeV]", NBINS, metbins);
      plots0l->addTreeVar("met_qcdcr_nbgeq1_nt1_lowmt",    "met",         sel["qcdcr"] + sel["nt1_lowmt"],                "#slash{E}_{T} [GeV]", NBINS, metbins);
      ...
      vector<TString> srbins = {"nb1_nt0_lowmt", "nb2_nt0_lowmt", "nb1_nt1_lowmt", "nb2_nt1_lowmt", "nb1_nt0_highmt", "nb2_nt0_highmt", "nb1_nt1_highmt", "nb2_nt1_highmt"};
      qcdcrtosr["nb1_nt0_lowmt"] = "nbgeq1_nt0_lowmt";
      qcdcrtosr["nb2_nt0_lowmt"] = "nbgeq1_nt0_lowmt";
      qcdcrtosr["nb1_nt1_lowmt"] = "nbgeq1_nt1_lowmt";
      qcdcrtosr["nb2_nt1_lowmt"] = "nbgeq1_nt1_lowmt";
      ...
      TH1F* qcd        = getQCDPred (file0l, "sr", "qcdcr", srbins, qcdcrtosr, bkgsamples);
