...
void makeROCCurves(const TString sigtree_400   = QCDSupport::inputDir + "/T2tt_800_100_tree.root",
                   const TString sigtree_600   = QCDSupport::inputDir + "/T2tt_800_100_tree.root",
                   ...
                   const TString outputname    = "comp")
{
  ...
  vector<TString> compmvas_training_2   = {"dphimhtj12_qcd", "dphistarmhtj12_qcd", "dphimhtj123_qcd", "dphistarmhtj123_qcd",  "dphimhtj1234_qcd", "dphistarmhtj1234_qcd"};
  ...
  plots_qcd->addROCVariable("dphimhtj12_qcd",               "dphimhtj12_qcd",              selqcd,         selqcd,     kRed,      1,        200, 0., 3.2);
  plots_qcd->addROCVariable("dphimhtj123_qcd",              "dphimhtj123_qcd",             selqcd,         selqcd,     kBlue,     1,        200, 0., 3.2);
  plots_qcd->addROCVariable("dphimhtj1234_qcd",             "dphimhtj1234_qcd",            selqcd,         selqcd,     kCyan,    1,        200, 0., 3.2);
  plots_qcd->addROCVariable("dphistarmhtj12_qcd",           "dphistarmhtj12_qcd",          selqcd,         selqcd,     kRed,      2,        200, 0., 3.2);
  plots_qcd->addROCVariable("dphistarmhtj123_qcd",          "dphistarmhtj123_qcd",         selqcd,         selqcd,     kBlue,     2,        200, 0., 3.2);
  plots_qcd->addROCVariable("dphistarmhtj1234_qcd",         "dphistarmhtj1234_qcd",        selqcd,         selqcd,     kCyan,    2,        200, 0., 3.2);

  //plots->    addCompPlot(outputname+"_qcdVariables_1_t2tt_800_100_tot",      compmvas_training);
  plots_qcd->addCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd",      compmvas_training_2);
  
  //plots->    getCompPlot(outputname+"_qcdVariables_1_t2tt_800_100_tot")->setLegend(0.45, 0.4, 0.9, 0.55);
  plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->setLegend(0.45, 0.4, 0.9, 0.55);
  ...
  //plots->    getCompPlot(outputname+"_qcdVariables_1_t2tt_800_100_tot")->addLine(0.0, sigeff_dphi12, bkgeff_dphi12, sigeff_dphi12, 1, 2, "#Delta#phij12 < 0.5");
  //plots->    getCompPlot(outputname+"_qcdVariables_1_t2tt_800_100_tot")->addLine(bkgeff_dphi12, 0.0, bkgeff_dphi12, sigeff_dphi12, 1, 2);
  //plots->    getCompPlot(outputname+"_qcdVariables_1_t2tt_800_100_tot")->addLine(0.0, sigeff_dphi123, bkgeff_dphi123, sigeff_dphi123, 1, 6, "#Delta#phij123 < 0.5");
  //plots->    getCompPlot(outputname+"_qcdVariables_1_t2tt_800_100_tot")->addLine(bkgeff_dphi123, 0.0, bkgeff_dphi123, sigeff_dphi123, 1, 6);
  ...
  //plots->    getCompPlot(outputname+"_qcdVariables_1_t2tt_800_100_tot")->addLine(0.0, sigeff_500_dphi12, bkgeff_500_dphi12, sigeff_500_dphi12, 1, 4, "#Delta#phij12 < 0.5");
  //plots->    getCompPlot(outputname+"_qcdVariables_1_t2tt_800_100_tot")->addLine(bkgeff_500_dphi12, 0.0, bkgeff_500_dphi12, sigeff_500_dphi12, 1, 4);
  //plots->    getCompPlot(outputname+"_qcdVariables_1_t2tt_800_100_tot")->addLine(0.0, sigeff_500_dphi123, bkgeff_500_dphi123, sigeff_500_dphi123, 1, 8, "#Delta#phij123 < 0.5");
  //plots->    getCompPlot(outputname+"_qcdVariables_1_t2tt_800_100_tot")->addLine(bkgeff_500_dphi123, 0.0, bkgeff_500_dphi123, sigeff_500_dphi123, 1, 8);
  //plots->plotAll();
  ...
  plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->addLine(0.0, sigeff_dphi12_qcd, bkgeff_dphi12_qcd, sigeff_dphi12_qcd, 1, 2, "#Delta#phij12 < 0.5");
  plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->addLine(bkgeff_dphi12_qcd, 0.0, bkgeff_dphi12_qcd, sigeff_dphi12_qcd, 1, 2);
  plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->addLine(0.0, sigeff_dphi123_qcd, bkgeff_dphi123_qcd, sigeff_dphi123_qcd, 1, 6, "#Delta#phij123 < 0.5");
  plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->addLine(bkgeff_dphi123_qcd, 0.0, bkgeff_dphi123_qcd, sigeff_dphi123_qcd, 1, 6);
  plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->addLine(0.0, sigeff_dphi1234_qcd, bkgeff_dphi1234_qcd, sigeff_dphi1234_qcd, 1, 6, "#Delta#phij1234 < 0.5");
  plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->addLine(bkgeff_dphi1234_qcd, 0.0, bkgeff_dphi1234_qcd, sigeff_dphi1234_qcd, 1, 6);
  ...
  //plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->addLine(0.0, sigeff_500_dphi12_qcd, bkgeff_500_dphi12_qcd, sigeff_500_dphi12_qcd, 1, 4, "#Delta#phij12 < 0.5");
  //plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->addLine(bkgeff_500_dphi12_qcd, 0.0, bkgeff_500_dphi12_qcd, sigeff_500_dphi12_qcd, 1, 4);
  //plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->addLine(0.0, sigeff_500_dphi123_qcd, bkgeff_500_dphi123_qcd, sigeff_500_dphi123_qcd, 1, 8, "#Delta#phij123 < 0.5");
  //plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->addLine(bkgeff_500_dphi123_qcd, 0.0, bkgeff_500_dphi123_qcd, sigeff_500_dphi123_qcd, 1, 8);
  //plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->addLine(0.0, sigeff_500_dphi1234_qcd, bkgeff_500_dphi1234_qcd, sigeff_500_dphi1234_qcd, 1, 8, "#Delta#phij1234 < 0.5");
  //plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2tt_800_100_qcd")->addLine(bkgeff_500_dphi1234_qcd, 0.0, bkgeff_500_dphi1234_qcd, sigeff_500_dphi1234_qcd, 1, 8);
  plots_qcd->plotAll();

  plots_qcd->getInfoForBackgroundEff("dphistarmhtj12_qcd",        bkgeff_dphi12_qcd);
  plots_qcd->getInfoForBackgroundEff("dphistarmhtj123_qcd",       bkgeff_dphi123_qcd);
  plots_qcd->getInfoForBackgroundEff("dphistarmhtj1234_qcd",      bkgeff_dphi1234_qcd);
  
  plots_qcd->getInfoForBackgroundEff("dphistarmhtj12_qcd",        0.5 + bkgeff_dphi12_qcd);
  plots_qcd->getInfoForBackgroundEff("dphistarmhtj123_qcd",       0.5 + bkgeff_dphi123_qcd);
  plots_qcd->getInfoForBackgroundEff("dphistarmhtj1234_qcd",      0.5 + bkgeff_dphi1234_qcd);
