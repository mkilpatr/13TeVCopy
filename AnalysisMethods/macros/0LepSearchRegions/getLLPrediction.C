...
void getLLPrediction(const TString defaultdir  = "/eos/uscms/store/user/vdutta/13TeV/trees/121815",
                     ...
                     const bool    plotlog     = false)
{
  ...
  TFile* srpred = 0;
  TString outfilename = dotnp ? outputdir + "/lostleppred_tnp.root" : outputdir + "/lostleppred.root";
  ...
  for(unsigned int i = 0; i < vars.size(); ++i) {
    ...
    for(unsigned int ivar = 0; ivar != NONE; ++ivar) {
      ...
      plotslepcr->addTreeVar("met_lepcr_nbgeq1_nt0_lowmt",    "met",         sel["lepcr"] + sel["nt0_lowmt"],                "#slash{E}_{T} [GeV]", NBINS, metbins);
      plotslepcr->addTreeVar("met_lepcr_nbgeq1_nt1_lowmt",    "met",         sel["lepcr"] + sel["nt1_lowmt"],                "#slash{E}_{T} [GeV]", NBINS, metbins);
      ...
      lepcrtosr["nb1_nt0_lowmt"] = "nbgeq1_nt0_lowmt";
      lepcrtosr["nb2_nt0_lowmt"] = "nbgeq1_nt0_lowmt";
      lepcrtosr["nb1_nt1_lowmt"] = "nbgeq1_nt1_lowmt";
      lepcrtosr["nb2_nt1_lowmt"] = "nbgeq1_nt1_lowmt";
