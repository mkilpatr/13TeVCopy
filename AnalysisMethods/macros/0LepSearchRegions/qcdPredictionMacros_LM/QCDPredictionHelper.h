...
void setTitleOffset(TCanvas *c, double xOff = .950, double yOff = 1.400){
  ...
  const TString inputDir = "../../../run/plots_16_11_15_Smear";
  ...
  const TString METBaseline = "passjson && passmetmht && (passmetfilters || process==10) && (met >= 250) && (j1chEnFrac > 0.1) && (j1chEnFrac < 0.99) && ((njl>=1) && (njets>=2) && (dphij1lmet>2.) && (j1lpt>=250) && (met/sqrt(ht)>=10))";
  ...
  const TString mj0_1 = "(metj1 < 300)";	             	                             const TString mj0_R = "(#slash{E}_{T} + j_{123}) < 300";       		   const TString mj0_L = "met + jets < 300";
  const TString mj300_1 = "((metj1 < 500) && (metj1 >= 300))";	                             const TString mj300_R = "300 <= (#slash{E}_{T} + j_{123}) < 500";             const TString mj300_L = "300 <= (met + jets) < 500";
  const TString mj500_1 = "((metj1 < 700) && (metj1 >= 500))";	                             const TString mj500_R = "500 <= (#slash{E}_{T} + j_{123}) < 700";             const TString mj500_L = "500 <= (met + jets) < 700";
  const TString mj700_1 = "(metj1 >= 700)";   			     			     const TString mj700_R = "(#slash{E}_{T} + j_{123}) >= 700"; 		   const TString mj700_L = "met + jets >= 700";
  ...
  const TString mjet = "(( " + dphi1 + " && metj1 ) || (" + dphi2 + " && metj2 ) || (" + dphi3 + " && metj3 ))";
...
//    }
  ...
  struct SRegInfo {
    ...
    enum  SRReg{ 
	SR_nb0_hgh_boost_low_nj, 
	SR_nb0_hgh_boost_hgh_nj, 
	SR_nb1_med_boost_low_pTb, 
	SR_nb1_med_boost_med_pTb, 
	SR_nb1_hgh_boost_low_pTb, 
	SR_nb1_hgh_boost_med_pTb, 
	SR_nb2_med_boost_low_pTb, 
	SR_nb2_med_boost_med_pTb, 
	SR_nb2_hgh_boost_low_pTb, 
	SR_nb2_hgh_boost_med_pTb, 
	//SR_nb0_mj0_hgh_boost_low_nj, 
	//SR_nb0_mj0_hgh_boost_hgh_nj, 
	//SR_nb1_mj0_med_boost_low_pTb, 
	//SR_nb1_mj0_med_boost_med_pTb, 
	//SR_nb1_mj0_hgh_boost_low_pTb, 
	//SR_nb1_mj0_hgh_boost_med_pTb, 
	//SR_nb2_mj0_med_boost_low_pTb, 
	//SR_nb2_mj0_med_boost_med_pTb, 
	//SR_nb2_mj0_hgh_boost_low_pTb, 
	//SR_nb2_mj0_hgh_boost_med_pTb, 
	//SR_nb0_mj300_hgh_boost_low_nj, 
	//SR_nb0_mj300_hgh_boost_hgh_nj, 
	//SR_nb1_mj300_med_boost_low_pTb, 
	//SR_nb1_mj300_med_boost_med_pTb, 
	//SR_nb1_mj300_hgh_boost_low_pTb, 
	//SR_nb1_mj300_hgh_boost_med_pTb, 
	//SR_nb2_mj300_med_boost_low_pTb, 
	//SR_nb2_mj300_med_boost_med_pTb, 
	//SR_nb2_mj300_hgh_boost_low_pTb, 
	//SR_nb2_mj300_hgh_boost_med_pTb, 
	//SR_nb0_mj500_hgh_boost_low_nj, 
	//SR_nb0_mj500_hgh_boost_hgh_nj, 
	//SR_nb1_mj500_med_boost_low_pTb, 
	//SR_nb1_mj500_med_boost_med_pTb, 
	//SR_nb1_mj500_hgh_boost_low_pTb, 
	//SR_nb1_mj500_hgh_boost_med_pTb, 
	//SR_nb2_mj500_med_boost_low_pTb, 
	//SR_nb2_mj500_med_boost_med_pTb, 
	//SR_nb2_mj500_hgh_boost_low_pTb, 
	//SR_nb2_mj500_hgh_boost_med_pTb, 
	//SR_nb0_mj700_hgh_boost_low_nj, 
	//SR_nb0_mj700_hgh_boost_hgh_nj, 
	//SR_nb1_mj700_med_boost_low_pTb, 
	//SR_nb1_mj700_med_boost_med_pTb, 
	//SR_nb1_mj700_hgh_boost_low_pTb, 
	//SR_nb1_mj700_hgh_boost_med_pTb, 
	//SR_nb2_mj700_med_boost_low_pTb, 
	//SR_nb2_mj700_med_boost_med_pTb, 
	//SR_nb2_mj700_hgh_boost_low_pTb, 
	//SR_nb2_mj700_hgh_boost_med_pTb 
};
	...
	//"nb0_mj0_highboost_lownj",   
	//"nb0_mj0_highboost_highnj",  
	//"nb1_mj0_medboost_lowptb",    
	//"nb1_mj0_medboost_medptb",    
	//"nb1_mj0_highboost_lowptb",   
	//"nb1_mj0_highboost_medptb",   
	//"nb2_mj0_medboost_lowptb",    
	//"nb2_mj0_medboost_medptb",    
	//"nb2_mj0_highboost_lowptb",   
	//"nb2_mj0_highboost_medptb",
	//"nb0_mj300_highboost_lownj",   
	//"nb0_mj300_highboost_highnj",  
	//"nb1_mj300_medboost_lowptb",    
	//"nb1_mj300_medboost_medptb",    
	//"nb1_mj300_highboost_lowptb",   
	//"nb1_mj300_highboost_medptb",   
	//"nb2_mj300_medboost_lowptb",    
	//"nb2_mj300_medboost_medptb",    
	//"nb2_mj300_highboost_lowptb",   
	//"nb2_mj300_highboost_medptb",
	//"nb0_mj500_highboost_lownj",   
	//"nb0_mj500_highboost_highnj",  
	//"nb1_mj500_medboost_lowptb",    
	//"nb1_mj500_medboost_medptb",    
	//"nb1_mj500_highboost_lowptb",   
	//"nb1_mj500_highboost_medptb",   
	//"nb2_mj500_medboost_lowptb",    
	//"nb2_mj500_medboost_medptb",    
	//"nb2_mj500_highboost_lowptb",   
	//"nb2_mj500_highboost_medptb",
	//"nb0_mj700_highboost_lownj",   
	//"nb0_mj700_highboost_highnj",  
	//"nb1_mj700_medboost_lowptb",    
	//"nb1_mj700_medboost_medptb",    
	//"nb1_mj700_highboost_lowptb",   
	//"nb1_mj700_highboost_medptb",   
	//"nb2_mj700_medboost_lowptb",    
	//"nb2_mj700_medboost_medptb",    
	//"nb2_mj700_highboost_lowptb",   
	//"nb2_mj700_highboost_medptb"
   };
    TString srSel[nSR] = {
                       nb0 + " && " + hgh_boost + " && " + med_nj,
                       nb0 + " && " + hgh_boost + " && " + hgh_nj,
        ...
        mtb + " && " + nb2 + " && " + hgh_boost + " && " + low_pTb12,
        mtb + " && " + nb2 + " && " + hgh_boost + " && " + med_pTb12,
        //               nb0 + " && " + hgh_boost + " && " + mj0 + " && " + med_nj,
        //               nb0 + " && " + hgh_boost + " && " + mj0 + " && " + hgh_nj,
        //mtb + " && " + nb1 + " && " + med_boost + " && " + mj0 + " && " + low_pTb,
        //mtb + " && " + nb1 + " && " + med_boost + " && " + mj0 + " && " + med_pTb,
        //mtb + " && " + nb1 + " && " + hgh_boost + " && " + mj0 + " && " + low_pTb,
        //mtb + " && " + nb1 + " && " + hgh_boost + " && " + mj0 + " && " + med_pTb,
        //mtb + " && " + nb2 + " && " + med_boost + " && " + mj0 + " && " + low_pTb12,
        //mtb + " && " + nb2 + " && " + med_boost + " && " + mj0 + " && " + med_pTb12,
        //mtb + " && " + nb2 + " && " + hgh_boost + " && " + mj0 + " && " + low_pTb12,
        //mtb + " && " + nb2 + " && " + hgh_boost + " && " + mj0 + " && " + med_pTb12,
        //               nb0 + " && " + hgh_boost + " && " + mj300 + " && " + med_nj,
        //               nb0 + " && " + hgh_boost + " && " + mj300 + " && " + hgh_nj,
        //mtb + " && " + nb1 + " && " + med_boost + " && " + mj300 + " && " + low_pTb,
        //mtb + " && " + nb1 + " && " + med_boost + " && " + mj300 + " && " + med_pTb,
        //mtb + " && " + nb1 + " && " + hgh_boost + " && " + mj300 + " && " + low_pTb,
        //mtb + " && " + nb1 + " && " + hgh_boost + " && " + mj300 + " && " + med_pTb,
        //mtb + " && " + nb2 + " && " + med_boost + " && " + mj300 + " && " + low_pTb12,
        //mtb + " && " + nb2 + " && " + med_boost + " && " + mj300 + " && " + med_pTb12,
        //mtb + " && " + nb2 + " && " + hgh_boost + " && " + mj300 + " && " + low_pTb12,
        //mtb + " && " + nb2 + " && " + hgh_boost + " && " + mj300 + " && " + med_pTb12,
        //               nb0 + " && " + hgh_boost + " && " + mj500 + " && " + med_nj,
        //               nb0 + " && " + hgh_boost + " && " + mj500 + " && " + hgh_nj,
        //mtb + " && " + nb1 + " && " + med_boost + " && " + mj500 + " && " + low_pTb,
        //mtb + " && " + nb1 + " && " + med_boost + " && " + mj500 + " && " + med_pTb,
        //mtb + " && " + nb1 + " && " + hgh_boost + " && " + mj500 + " && " + low_pTb,
        //mtb + " && " + nb1 + " && " + hgh_boost + " && " + mj500 + " && " + med_pTb,
        //mtb + " && " + nb2 + " && " + med_boost + " && " + mj500 + " && " + low_pTb12,
        //mtb + " && " + nb2 + " && " + med_boost + " && " + mj500 + " && " + med_pTb12,
        //mtb + " && " + nb2 + " && " + hgh_boost + " && " + mj500 + " && " + low_pTb12,
        //mtb + " && " + nb2 + " && " + hgh_boost + " && " + mj500 + " && " + med_pTb12,
        //               nb0 + " && " + hgh_boost + " && " + mj700 + " && " + med_nj,
        //               nb0 + " && " + hgh_boost + " && " + mj700 + " && " + hgh_nj,
        //mtb + " && " + nb1 + " && " + med_boost + " && " + mj700 + " && " + low_pTb,
        //mtb + " && " + nb1 + " && " + med_boost + " && " + mj700 + " && " + med_pTb,
        //mtb + " && " + nb1 + " && " + hgh_boost + " && " + mj700 + " && " + low_pTb,
        //mtb + " && " + nb1 + " && " + hgh_boost + " && " + mj700 + " && " + med_pTb,
        //mtb + " && " + nb2 + " && " + med_boost + " && " + mj700 + " && " + low_pTb12,
        //mtb + " && " + nb2 + " && " + med_boost + " && " + mj700 + " && " + med_pTb12,
        //mtb + " && " + nb2 + " && " + hgh_boost + " && " + mj700 + " && " + low_pTb12,
        //mtb + " && " + nb2 + " && " + hgh_boost + " && " + mj700 + " && " + med_pTb12,
    };
    TString srSelLabels[nSR] = {
        ...
        //"#splitline{" + mj0_R + ", " + nb0_R + ", " + hgh_boost_R + "}{"                + med_nj_R    + "}",
        //"#splitline{" + mj0_R + ", " + nb0_R + ", " + hgh_boost_R + "}{"                + hgh_nj_R    + "}",
        //"#splitline{" + mj0_R + ", " + nb1_R + ", " + med_boost_R + "}{" + mtb_R + ", " + low_pTb_R   + "}",
        //"#splitline{" + mj0_R + ", " + nb1_R + ", " + med_boost_R + "}{" + mtb_R + ", " + med_pTb_R   + "}",
        //"#splitline{" + mj0_R + ", " + nb1_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + low_pTb_R   + "}",
        //"#splitline{" + mj0_R + ", " + nb1_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + med_pTb_R   + "}",
        //"#splitline{" + mj0_R + ", " + nb2_R + ", " + med_boost_R + "}{" + mtb_R + ", " + low_pTb12_R + "}",
        //"#splitline{" + mj0_R + ", " + nb2_R + ", " + med_boost_R + "}{" + mtb_R + ", " + med_pTb12_R + "}",
        //"#splitline{" + mj0_R + ", " + nb2_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + low_pTb12_R + "}",
        //"#splitline{" + mj0_R + ", " + nb2_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + med_pTb12_R + "}",
        //"#splitline{" + mj300_R + ", " + nb0_R + ", " + hgh_boost_R + "}{"                + med_nj_R    + "}",
        //"#splitline{" + mj300_R + ", " + nb0_R + ", " + hgh_boost_R + "}{"                + hgh_nj_R    + "}",
        //"#splitline{" + mj300_R + ", " + nb1_R + ", " + med_boost_R + "}{" + mtb_R + ", " + low_pTb_R   + "}",
        //"#splitline{" + mj300_R + ", " + nb1_R + ", " + med_boost_R + "}{" + mtb_R + ", " + med_pTb_R   + "}",
        //"#splitline{" + mj300_R + ", " + nb1_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + low_pTb_R   + "}",
        //"#splitline{" + mj300_R + ", " + nb1_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + med_pTb_R   + "}",
        //"#splitline{" + mj300_R + ", " + nb2_R + ", " + med_boost_R + "}{" + mtb_R + ", " + low_pTb12_R + "}",
        //"#splitline{" + mj300_R + ", " + nb2_R + ", " + med_boost_R + "}{" + mtb_R + ", " + med_pTb12_R + "}",
        //"#splitline{" + mj300_R + ", " + nb2_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + low_pTb12_R + "}",
        //"#splitline{" + mj300_R + ", " + nb2_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + med_pTb12_R + "}",
        //"#splitline{" + mj500_R + ", " + nb0_R + ", " + hgh_boost_R + "}{"                + med_nj_R    + "}",
        //"#splitline{" + mj500_R + ", " + nb0_R + ", " + hgh_boost_R + "}{"                + hgh_nj_R    + "}",
        //"#splitline{" + mj500_R + ", " + nb1_R + ", " + med_boost_R + "}{" + mtb_R + ", " + low_pTb_R   + "}",
        //"#splitline{" + mj500_R + ", " + nb1_R + ", " + med_boost_R + "}{" + mtb_R + ", " + med_pTb_R   + "}",
        //"#splitline{" + mj500_R + ", " + nb1_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + low_pTb_R   + "}",
        //"#splitline{" + mj500_R + ", " + nb1_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + med_pTb_R   + "}",
        //"#splitline{" + mj500_R + ", " + nb2_R + ", " + med_boost_R + "}{" + mtb_R + ", " + low_pTb12_R + "}",
        //"#splitline{" + mj500_R + ", " + nb2_R + ", " + med_boost_R + "}{" + mtb_R + ", " + med_pTb12_R + "}",
        //"#splitline{" + mj500_R + ", " + nb2_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + low_pTb12_R + "}",
        //"#splitline{" + mj500_R + ", " + nb2_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + med_pTb12_R + "}",
        //"#splitline{" + mj700_R+ ", " + nb0_R + ", " + hgh_boost_R + "}{"                + med_nj_R    + "}",
        //"#splitline{" + mj700_R+ ", " + nb0_R + ", " + hgh_boost_R + "}{"                + hgh_nj_R    + "}",
        //"#splitline{" + mj700_R+ ", " + nb1_R + ", " + med_boost_R + "}{" + mtb_R + ", " + low_pTb_R   + "}",
        //"#splitline{" + mj700_R+ ", " + nb1_R + ", " + med_boost_R + "}{" + mtb_R + ", " + med_pTb_R   + "}",
        //"#splitline{" + mj700_R+ ", " + nb1_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + low_pTb_R   + "}",
        //"#splitline{" + mj700_R+ ", " + nb1_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + med_pTb_R   + "}",
        //"#splitline{" + mj700_R+ ", " + nb2_R + ", " + med_boost_R + "}{" + mtb_R + ", " + low_pTb12_R + "}",
        //"#splitline{" + mj700_R+ ", " + nb2_R + ", " + med_boost_R + "}{" + mtb_R + ", " + med_pTb12_R + "}",
        //"#splitline{" + mj700_R+ ", " + nb2_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + low_pTb12_R + "}",
        //"#splitline{" + mj700_R+ ", " + nb2_R + ", " + hgh_boost_R + "}{" + mtb_R + ", " + med_pTb12_R + "}",
    };
    TString srSelNamesLatex[nSR] = {
        ...
        mtb_L + ", " + nb2_L + ", " + hgh_boost_L + ", " + low_pTb12_L,
        mtb_L + ", " + nb2_L + ", " + hgh_boost_L + ", " + med_pTb12_L,
        //               nb0_L + ", " + mj0_L + ", " + hgh_boost_L + ", " + med_nj_L,
        //               nb0_L + ", " + mj0_L + ", " + hgh_boost_L + ", " + hgh_nj_L,
        //mtb_L + ", " + nb1_L + ", " + mj0_L + ", " + med_boost_L + ", " + low_pTb_L,
        //mtb_L + ", " + nb1_L + ", " + mj0_L + ", " + med_boost_L + ", " + med_pTb_L,
        //mtb_L + ", " + nb1_L + ", " + mj0_L + ", " + hgh_boost_L + ", " + low_pTb_L,
        //mtb_L + ", " + nb1_L + ", " + mj0_L + ", " + hgh_boost_L + ", " + med_pTb_L,
        //mtb_L + ", " + nb2_L + ", " + mj0_L + ", " + med_boost_L + ", " + low_pTb12_L,
        //mtb_L + ", " + nb2_L + ", " + mj0_L + ", " + med_boost_L + ", " + med_pTb12_L,
        //mtb_L + ", " + nb2_L + ", " + mj0_L + ", " + hgh_boost_L + ", " + low_pTb12_L,
        //mtb_L + ", " + nb2_L + ", " + mj0_L + ", " + hgh_boost_L + ", " + med_pTb12_L,
        //               nb0_L + ", " + mj300_L + ", " + hgh_boost_L + ", " + med_nj_L,
        //               nb0_L + ", " + mj300_L + ", " + hgh_boost_L + ", " + hgh_nj_L,
        //mtb_L + ", " + nb1_L + ", " + mj300_L + ", " + med_boost_L + ", " + low_pTb_L,
        //mtb_L + ", " + nb1_L + ", " + mj300_L + ", " + med_boost_L + ", " + med_pTb_L,
        //mtb_L + ", " + nb1_L + ", " + mj300_L + ", " + hgh_boost_L + ", " + low_pTb_L,
        //mtb_L + ", " + nb1_L + ", " + mj300_L + ", " + hgh_boost_L + ", " + med_pTb_L,
        //mtb_L + ", " + nb2_L + ", " + mj300_L + ", " + med_boost_L + ", " + low_pTb12_L,
        //mtb_L + ", " + nb2_L + ", " + mj300_L + ", " + med_boost_L + ", " + med_pTb12_L,
        //mtb_L + ", " + nb2_L + ", " + mj300_L + ", " + hgh_boost_L + ", " + low_pTb12_L,
        //mtb_L + ", " + nb2_L + ", " + mj300_L + ", " + hgh_boost_L + ", " + med_pTb12_L,
        //               nb0_L + ", " + mj500_L + ", " + hgh_boost_L + ", " + med_nj_L,
        //               nb0_L + ", " + mj500_L + ", " + hgh_boost_L + ", " + hgh_nj_L,
        //mtb_L + ", " + nb1_L + ", " + mj500_L + ", " + med_boost_L + ", " + low_pTb_L,
        //mtb_L + ", " + nb1_L + ", " + mj500_L + ", " + med_boost_L + ", " + med_pTb_L,
        //mtb_L + ", " + nb1_L + ", " + mj500_L + ", " + hgh_boost_L + ", " + low_pTb_L,
        //mtb_L + ", " + nb1_L + ", " + mj500_L + ", " + hgh_boost_L + ", " + med_pTb_L,
        //mtb_L + ", " + nb2_L + ", " + mj500_L + ", " + med_boost_L + ", " + low_pTb12_L,
        //mtb_L + ", " + nb2_L + ", " + mj500_L + ", " + med_boost_L + ", " + med_pTb12_L,
        //mtb_L + ", " + nb2_L + ", " + mj500_L + ", " + hgh_boost_L + ", " + low_pTb12_L,
        //mtb_L + ", " + nb2_L + ", " + mj500_L + ", " + hgh_boost_L + ", " + med_pTb12_L,
        //               nb0_L + ", " + mj700_L +", " + hgh_boost_L + ", " + med_nj_L,
        //               nb0_L + ", " + mj700_L +", " + hgh_boost_L + ", " + hgh_nj_L,
        //mtb_L + ", " + nb1_L + ", " + mj700_L +", " + med_boost_L + ", " + low_pTb_L,
        //mtb_L + ", " + nb1_L + ", " + mj700_L +", " + med_boost_L + ", " + med_pTb_L,
        //mtb_L + ", " + nb1_L + ", " + mj700_L +", " + hgh_boost_L + ", " + low_pTb_L,
        //mtb_L + ", " + nb1_L + ", " + mj700_L +", " + hgh_boost_L + ", " + med_pTb_L,
        //mtb_L + ", " + nb2_L + ", " + mj700_L +", " + med_boost_L + ", " + low_pTb12_L,
        //mtb_L + ", " + nb2_L + ", " + mj700_L +", " + med_boost_L + ", " + med_pTb12_L,
        //mtb_L + ", " + nb2_L + ", " + mj700_L +", " + hgh_boost_L + ", " + low_pTb12_L,
        //mtb_L + ", " + nb2_L + ", " + mj700_L +", " + hgh_boost_L + ", " + med_pTb12_L,
    };
    TString srSelNames[nSR] = {
        ...
        mtb_R + ", " + nb2_R + ", " + hgh_boost_R + ", " + low_pTb12_R,
        mtb_R + ", " + nb2_R + ", " + hgh_boost_R + ", " + med_pTb12_R,
        //               nb0_R + ", " + mj0_R + ", "  + hgh_boost_R + ", " + med_nj_R,
        //               nb0_R + ", " + mj0_R + ", "  + hgh_boost_R + ", " + hgh_nj_R,
        //mtb_R + ", " + nb1_R + ", " + mj0_R + ", "  + med_boost_R + ", " + low_pTb_R,
        //mtb_R + ", " + nb1_R + ", " + mj0_R + ", "  + med_boost_R + ", " + med_pTb_R,
        //mtb_R + ", " + nb1_R + ", " + mj0_R + ", "  + hgh_boost_R + ", " + low_pTb_R,
        //mtb_R + ", " + nb1_R + ", " + mj0_R + ", "  + hgh_boost_R + ", " + med_pTb_R,
        //mtb_R + ", " + nb2_R + ", " + mj0_R + ", "  + med_boost_R + ", " + low_pTb12_R,
        //mtb_R + ", " + nb2_R + ", " + mj0_R + ", "  + med_boost_R + ", " + med_pTb12_R,
        //mtb_R + ", " + nb2_R + ", " + mj0_R + ", "  + hgh_boost_R + ", " + low_pTb12_R,
        //mtb_R + ", " + nb2_R + ", " + mj0_R + ", "  + hgh_boost_R + ", " + med_pTb12_R,
        //               nb0_R + ", " + mj300_R + ", "  + hgh_boost_R + ", " + med_nj_R,
        //               nb0_R + ", " + mj300_R + ", "  + hgh_boost_R + ", " + hgh_nj_R,
        //mtb_R + ", " + nb1_R + ", " + mj300_R + ", "  + med_boost_R + ", " + low_pTb_R,
        //mtb_R + ", " + nb1_R + ", " + mj300_R + ", "  + med_boost_R + ", " + med_pTb_R,
        //mtb_R + ", " + nb1_R + ", " + mj300_R + ", "  + hgh_boost_R + ", " + low_pTb_R,
        //mtb_R + ", " + nb1_R + ", " + mj300_R + ", "  + hgh_boost_R + ", " + med_pTb_R,
        //mtb_R + ", " + nb2_R + ", " + mj300_R + ", "  + med_boost_R + ", " + low_pTb12_R,
        //mtb_R + ", " + nb2_R + ", " + mj300_R + ", "  + med_boost_R + ", " + med_pTb12_R,
        //mtb_R + ", " + nb2_R + ", " + mj300_R + ", "  + hgh_boost_R + ", " + low_pTb12_R,
        //mtb_R + ", " + nb2_R + ", " + mj300_R + ", "  + hgh_boost_R + ", " + med_pTb12_R,
        //               nb0_R + ", " + mj500_R + ", "  + hgh_boost_R + ", " + med_nj_R,
        //               nb0_R + ", " + mj500_R + ", "  + hgh_boost_R + ", " + hgh_nj_R,
        //mtb_R + ", " + nb1_R + ", " + mj500_R + ", "  + med_boost_R + ", " + low_pTb_R,
        //mtb_R + ", " + nb1_R + ", " + mj500_R + ", "  + med_boost_R + ", " + med_pTb_R,
        //mtb_R + ", " + nb1_R + ", " + mj500_R + ", "  + hgh_boost_R + ", " + low_pTb_R,
        //mtb_R + ", " + nb1_R + ", " + mj500_R + ", "  + hgh_boost_R + ", " + med_pTb_R,
        //mtb_R + ", " + nb2_R + ", " + mj500_R + ", "  + med_boost_R + ", " + low_pTb12_R,
        //mtb_R + ", " + nb2_R + ", " + mj500_R + ", "  + med_boost_R + ", " + med_pTb12_R,
        //mtb_R + ", " + nb2_R + ", " + mj500_R + ", "  + hgh_boost_R + ", " + low_pTb12_R,
        //mtb_R + ", " + nb2_R + ", " + mj500_R + ", "  + hgh_boost_R + ", " + med_pTb12_R,
        //               nb0_R + ", " + mj700_R + ", " + hgh_boost_R + ", " + med_nj_R,
        //               nb0_R + ", " + mj700_R + ", " + hgh_boost_R + ", " + hgh_nj_R,
        //mtb_R + ", " + nb1_R + ", " + mj700_R + ", " + med_boost_R + ", " + low_pTb_R,
        //mtb_R + ", " + nb1_R + ", " + mj700_R + ", " + med_boost_R + ", " + med_pTb_R,
        //mtb_R + ", " + nb1_R + ", " + mj700_R + ", " + hgh_boost_R + ", " + low_pTb_R,
        //mtb_R + ", " + nb1_R + ", " + mj700_R + ", " + hgh_boost_R + ", " + med_pTb_R,
        //mtb_R + ", " + nb2_R + ", " + mj700_R + ", " + med_boost_R + ", " + low_pTb12_R,
        //mtb_R + ", " + nb2_R + ", " + mj700_R + ", " + med_boost_R + ", " + med_pTb12_R,
        //mtb_R + ", " + nb2_R + ", " + mj700_R + ", " + hgh_boost_R + ", " + low_pTb12_R,
        //mtb_R + ", " + nb2_R + ", " + mj700_R + ", " + hgh_boost_R + ", " + med_pTb12_R,
    };
