                   ...
                   const TString outputname    = "comp")
{
  ...
  //vector<TString> compmvas_training   = {"dphimetj12", "dphistarmetj12", "omegametj12", "chimetj12", "dphimetj12_qcd", "dphistarmetj12_qcd", "omegametj12_qcd", "chimetj12_qcd"};
  ...
  float sigeff_dphi12_qcd =     EffPlotTools::getEfficiencyForCutValue(plots_qcd->getSigHist("dphimetj12"),     0.50, 0)[0];
  float bkgeff_dphi12_qcd =     EffPlotTools::getEfficiencyForCutValue(plots_qcd->getBkgHist("dphimetj12"),     0.50, 0)[0];
  float sigeff_dphi123_qcd =    EffPlotTools::getEfficiencyForCutValue(plots_qcd->getSigHist("dphimetj123"),    0.15, 0)[0];
  float bkgeff_dphi123_qcd =    EffPlotTools::getEfficiencyForCutValue(plots_qcd->getBkgHist("dphimetj123"),    0.15, 0)[0];
  float sigeff_dphi1234_qcd =   EffPlotTools::getEfficiencyForCutValue(plots_qcd->getSigHist("dphimetj1234"),   0.50, 0)[0];
  float bkgeff_dphi1234_qcd =   EffPlotTools::getEfficiencyForCutValue(plots_qcd->getBkgHist("dphimetj1234"),   0.50, 0)[0];
  ...
  //plots_qcd->getInfoForCut("dphimetj12_qcd", 0.5);
  //plots_qcd->getInfoForCut("dphimetj123_qcd", 0.5);
//}
