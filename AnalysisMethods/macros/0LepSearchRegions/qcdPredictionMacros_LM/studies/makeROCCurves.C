...
void makeROCCurves(const TString sigtree_fbd   = QCDSupport::inputDir + "/T2fbd_400_350_tree.root",
		   ...
		   const TString siglabel_fbd  = "T2fbd(400, 350)",
                   const TString bkglabel_tot  = "Total Bkg LM",
		   const TString bkglabel_qcd  = "QCD Bkg LM",
                   ...
                   const TString outputname    = "comp")
{
  ...
  float sigeff_dphi12_qcd =     EffPlotTools::getEfficiencyForCutValue(plots_qcd->getSigHist("dphimhtj12_qcd"),     0.50, 0)[0];
  float bkgeff_dphi12_qcd =     EffPlotTools::getEfficiencyForCutValue(plots_qcd->getBkgHist("dphimhtj12_qcd"),     0.50, 0)[0];
  float sigeff_dphi123_qcd =    EffPlotTools::getEfficiencyForCutValue(plots_qcd->getSigHist("dphimhtj123_qcd"),    0.15, 0)[0];
  float bkgeff_dphi123_qcd =    EffPlotTools::getEfficiencyForCutValue(plots_qcd->getBkgHist("dphimhtj123_qcd"),    0.15, 0)[0];
  float sigeff_dphi1234_qcd =   EffPlotTools::getEfficiencyForCutValue(plots_qcd->getSigHist("dphimhtj1234_qcd"),   0.15, 0)[0];
  float bkgeff_dphi1234_qcd =   EffPlotTools::getEfficiencyForCutValue(plots_qcd->getBkgHist("dphimhtj1234_qcd"),   0.15, 0)[0];
  ...
  plots_qcd->getCompPlot(outputname+"_qcdVariables_2_t2fbd_400_350_qcd")->addLine(0.0, sigeff_dphi123_qcd, bkgeff_dphi123_qcd, sigeff_dphi123_qcd, 1, 6, "#Delta#phij123 < 0.15");
