                            ...
                            const bool    plotlog = true)
{
  ...
  if (plotbkgunc) {
    plot_sr1->addHist(bkgtotal, "Bkg. Uncertainty", "E2", kBlue+1, 3013, 0, 0, 0, 0);
    plot_sr1->setName(plot_sr1->getName()+"_bkgunc");
    plot_sr2->addHist(bkgtotal, "Bkg. Uncertainty", "E2", kBlue+1, 3013, 0, 0, 0, 0);
    plot_sr2->setName(plot_sr2->getName()+"_bkgunc");
    plot_sr3->addHist(bkgtotal, "Bkg. Uncertainty", "E2", kBlue+1, 3013, 0, 0, 0, 0);
    plot_sr3->setName(plot_sr3->getName()+"_bkgunc");
    plot_sr4->addHist(bkgtotal, "Bkg. Uncertainty", "E2", kBlue+1, 3013, 0, 0, 0, 0);
    plot_sr4->setName(plot_sr4->getName()+"_bkgunc");
    plot_sr5->addHist(bkgtotal, "Bkg. Uncertainty", "E2", kBlue+1, 3013, 0, 0, 0, 0);
