...
const TString datasel = " && passjson && passcscbeamhaloflt && passeebadscflt && passeebadsc4flt && passhbheisoflt && passhbhefltloose && ( (ljCHEF > 0.1) *(process <= 1  ) + 1.0*(process > 1  ))";
...
std::map<TString, std::vector<int>> srMETbins{
  {"nb0_medboost_mednj",         {350, 450, 550, 650, 1000}},
  {"nb0_medboost_highnj",        {350, 450, 550, 650, 1000}},
  {"nb0_highboost_mednj",        {     450, 550, 650, 750, 1000}},
  {"nb0_highboost_highnj",       {     450, 550, 650, 750, 1000}},

  {"nb1_medboost_lowptb",   {250, 350, 450, 550, 1000}},
  {"nb1_medboost_medptb",   {250, 350, 450, 550, 1000}},
  {"nb1_medboost_highptb",       {350, 450, 550, 1000}},
  {"nb1_highboost_lowptb",       {350, 450, 550, 650, 1000}},
  {"nb1_highboost_medptb",       {350, 450, 550, 650, 1000}},
  {"nb1_highboost_highptb",           {450, 550, 650, 1000}}
};
