...
vector<Quantity> getYieldVector(TTree *intree, TString wgtvar, TString sel, const BinInfo &bin){
  ...
  htmp.Sumw2();
  TString cutstr = wgtvar + "*(" + sel + ")";
  intree->Project("htmp", bin.var, cutstr, "e");
...
#ifdef DEBUG_
  cout << intree->GetTitle() << ": " << cutstr << ", " << bin.var << endl
       << "  --> " << yields << endl;
#endif
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//vector<Quantity> getYieldVector2(TTree *intree, TString wgtvar, TString sel, const BinInfo &bin){
//  assert(intree);
//
...
//    }
  ...
  hbkgtotal->SetMaximum(plotMax*ymax);
  hbkgtotal->SetMinimum(plotlog ? 0.01 : 0);
  hbkgtotal->Draw("hist");
...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
TCanvas* drawStackAndRatio(vector<TH1*> inhists, TH1* inData, TLegend *leg = 0, TString ratioYTitle = "N_{obs}/N_{exp}", double lowY = RATIO_YMIN, double highY = RATIO_YMAX)
{
  double plotMax = leg?PLOT_MAX_YSCALE/leg->GetY1():PLOT_MAX_YSCALE;
