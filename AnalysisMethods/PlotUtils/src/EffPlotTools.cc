...
namespace EffPlotTools {
  ...
  TGraphAsymmErrors* computeEffGraph(TH1F* pass, TH1F* total, bool debug) {
  ...
  TGraph* computeROCCurve(TH1F* signal, TH1F* background, TString title, bool reversecutdir, bool plotbkgrej, bool reverseaxes)
  {
  ...
  float * getCutValueForEfficiency(TH1F* hist, float targeteff, bool reversecutdir)
  {
  ...
  float * getEfficiencyForCutValue(TH1F* hist, float cut, bool reversecutdir)
  {
  ...
  float * getCutValueForBestEffSOverSqrtEffB(TH1F* sighist, TH1F* bkghist, bool reversecutdir)
  {
