...
do
	./makejobs.py --makegrid -i $i --inputdir /eos/uscms/store/user/mkilpatr/13TeV/ntuples/merged -o /eos/uscms/store/user/mkilpatr/13TeV/ntuples/merged --mlspsteps 10
done
