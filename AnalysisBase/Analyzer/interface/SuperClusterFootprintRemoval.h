...
//    rechit_link_enlargement_forSCremoval (0.25) : enlargement of linear dimension of xtals for rechit matching
  SuperClusterFootprintRemoval(edm::Handle<pat::ElectronCollection>& electronsHandle, edm::Handle<pat::MuonCollection>& muonsHandle, edm::Handle<pat::PhotonCollection>& photonsHandle, edm::Handle<pat::JetCollection>& jetsToken, edm::Handle<pat::PackedCandidateCollection>& pfCandidate, CaloSubdetectorGeometry *barrelgeometry, CaloSubdetectorGeometry *endcapgeometry, MagneticField *magfield,const double photonptMinRC_, const double jetptMinRC_,const double leptonptMinRC_,edm::ParameterSet iConfig = edm::ParameterSet());
  //SuperClusterFootprintRemoval(edm::Handle<std::vector<pat::Electron> >/*edm::Handle<pat::ElectronCollection> electronsHandle,edm::Handle<pat::MuonCollection> muonsHandle, edm::Handle<pat::PhotonCollection> photonsHandle, edm::Handle<pat::JetCollection> jetsHandle,edm::Handle<pat::PackedCandidateCollection> pfcandidatesHandle*/, const edm::EventSetup& iSetup, edm::ParameterSet iConfig = edm::ParameterSet());
