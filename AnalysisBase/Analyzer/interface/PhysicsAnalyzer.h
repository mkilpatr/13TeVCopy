...
namespace ucsbsusy {
  ...
  public:
    ...
    public :
      ...
      //--------------------------------------------------------------------------------------------------
    public:
      enum VarType {EVTINFO, AK4JETS, PUPPIJETS, PICKYJETS, CASUBJETS, CA8JETS, ELECTRONS, MUONS, TAUS, PRODISOTRKS, PHOTONS, PFCANDS, GENPARTICLES, CMSTOPS, AK8FATJETS, AK8PUPPIFATJETS, TRIGGERS, METFILTERS, SV, HTTJETS};
