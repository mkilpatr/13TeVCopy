...
// Class:      prodIsoTrksTest
// 
/**\class prodIsoTrksTest prodIsoTrksTest.cc SusyAnaTools/TreeMaker/plugins/prodIsoTrksTest.cc
 * 
...
//
prodIsoTrksTest::prodIsoTrksTest(const edm::ParameterSet& iConfig)
...
prodIsoTrksTest::~prodIsoTrksTest()
{
...
void
prodIsoTrksTest::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace edm;
...
void 
prodIsoTrksTest::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
prodIsoTrksTest::endJob() {
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
prodIsoTrksTest::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
void 
prodIsoTrksTest::setBranchVariablesToDefault() 
{
  // event information
  runNum_=0;
  lumiBlockNum_=0;
...
TString prodIsoTrksTest::formBranchName(const edm::InputTag & varTag, const std::vector<std::string> & vectorNames){
...
DEFINE_FWK_MODULE(prodIsoTrksTest);
