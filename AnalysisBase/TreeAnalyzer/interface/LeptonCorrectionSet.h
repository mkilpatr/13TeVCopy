...
namespace ucsbsusy {
  ...
  class TnPCorr : public HistogramCorrection {
    public:
    TnPCorr(TFile * file)  : HistogramCorrection("TNP",file) {}
    double getLepWeight(TnPCorr* tnpCorr, const LeptonF* lep                  , CORRTYPE elCorrType, CORRTYPE muCorrType ) const;
