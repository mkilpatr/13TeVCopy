...
class CASubjetCountingTreeProducer : public PhysicsAnalyzer {
  ...
  enum SplitDecision {NOSPLIT_NO_PARENTS, NOSPLIT_BELOW_MCUT, NOSPLIT_FAIL_PTCUT, NOSPLIT_BELOW_DRMIN, SPLIT_BOTH_SUBJETS, SPLIT_LEADING_SUBJET, PICKY_SHOULD_SPLIT, NOSPLIT_TOO_MANY_SPLITS, NOSPLIT_FAIL_MVA};
    ...
    ucsbsusy::size irun                 ;
    ucsbsusy::size ilumi                ;
    ucsbsusy::size ievent               ;
    ucsbsusy::size itoppt               ;
    ucsbsusy::size itopeta              ;
    ucsbsusy::size itopphi              ;
    ucsbsusy::size itopmass             ;
    ucsbsusy::size itoppartindex        ;
    ucsbsusy::size itoppartpt           ;
    ucsbsusy::size itopparteta          ;
    ucsbsusy::size itoppartphi          ;
    ucsbsusy::size itoppartenergy       ;
    ucsbsusy::size itopparthade         ;
    ucsbsusy::size nGoodPartons         ;
    ucsbsusy::size nVert                ;
    ...
    ucsbsusy::size superJet_gene        ;
    ucsbsusy::size superJet_prtIndex    ;
    ...
    ucsbsusy::size subJet_1_gene        ;
    ucsbsusy::size subJet_1_prtIndex    ;
    ...
    ucsbsusy::size subJet_2_gene        ;
    ucsbsusy::size subJet_2_prtIndex    ;
    ucsbsusy::size subJet_2_purity      ;
    ucsbsusy::size didSplit             ;
